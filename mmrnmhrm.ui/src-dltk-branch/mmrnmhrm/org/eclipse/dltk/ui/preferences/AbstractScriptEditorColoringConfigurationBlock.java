...
package mmrnmhrm.org.eclipse.dltk.ui.preferences;
...
//import org.eclipse.dltk.ui.preferences.ColorListContentProvider;
//import org.eclipse.dltk.ui.preferences.ColorListLabelProvider;
//import org.eclipse.dltk.ui.preferences.HighlightingColorListItem;
import org.eclipse.dltk.ui.preferences.OverlayPreferenceStore;
import org.eclipse.dltk.ui.preferences.PreferencesMessages;
//import org.eclipse.dltk.ui.preferences.SemanticHighlightingColorListItem;
...
//XXX: DLTK copy 0.9 changed privates to proctected; expand tree; increased sel size 
/**
...
//									.getEnabledPreferenceKey(semanticHighlightings[i])));
	...
	public void initialize() {
		...
		fListViewer.expandAll(); // DLTK branch change
	}
	...
	private Control createSyntaxPage(final Composite parent) {
		...
		gd.heightHint = convertHeightInCharsToPixels(10); // DLTK branch change
		int maxWidth = 0;
		...
		if (vBar != null)
			maxWidth += vBar.getSize().x * 3; // scrollbars and tree
												// indentation guess
		gd.widthHint = maxWidth + 40; // DLTK branch change
