 ...
 * </p>
 * 
 * TODO JDT UI actions put back all (or some) actions
 * 
 * @since 2.0
 */
public class GenerateActionGroup extends ActionGroup {
	...
	/**
	 * Pop-up menu: id of the source sub menu (value <code>descent.ui.source.menu</code>).
	 * 
	 * @since 3.0
	 */
	public static final String MENU_ID= "descent.ui.source.menu"; //$NON-NLS-1$
...
//	private SortMembersAction fSortMembers;
	...
	private static final String QUICK_MENU_ID= "descent.ui.edit.text.java.source.quickMenu"; //$NON-NLS-1$
