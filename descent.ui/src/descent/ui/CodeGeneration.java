...
public class CodeGeneration {
	 ...
	 * types names (dot separated). See {@link descent.core.IType#getTypeQualifiedName(char)}.
	 * @param lineDelimiter The line delimiter to be used.
	 * @return Returns the new content or <code>null</code> if the code template is undefined or empty. The returned content is unformatted and is not indented.
	 * @throws CoreException Thrown when the evaluation of the code template fails.
	 */	
	 ...
	 * See {@link descent.core.dom.AST#newMethodDeclaration()} for how to create such a node.
	 ...
	 * would return the array <code>{"QString;","I"}</code> as parameter types. See {@link descent.core.Signature}.
	 * 
	 * @param cu The compilation unit to which the method belongs. The compilation unit does not need to exist.
	 * @param declaringTypeName Name of the type to which the method belongs. For inner types the name must be qualified and include the outer
	 * types names (dot separated). See {@link descent.core.IType#getTypeQualifiedName(char)}.
	...
	public static String getMethodComment(IMethod method, IMethod overridden, String lineDelimiter) throws CoreException {
		...
		return StubUtility.getMethodComment(method.getCompilationUnit(), method.getDeclaringType() == null ? null : method.getDeclaringType().getElementName(),
	...
	public static String getMethodComment(ICompilationUnit cu, String declaringTypeName, AbstractFunctionDeclaration decl, boolean isDeprecated, String overriddenMethodName, String overriddenMethodDeclaringTypeName, String[] overriddenMethodParameterTypeNames, String lineDelimiter) throws CoreException {
