 ...
 * <code>descent.ui.javaFoldingStructureProvider</code> extension
...
class EmptyJavaFoldingPreferenceBlock implements IJavaFoldingPreferenceBlock {
	...
	/*
	 * @see descent.internal.ui.text.folding.IJavaFoldingPreferenceBlock#initialize()
	 */
	public void initialize() {
	}

	/*
	 * @see descent.internal.ui.text.folding.IJavaFoldingPreferenceBlock#performOk()
	 */
	public void performOk() {
	}

	/*
	 * @see descent.internal.ui.text.folding.IJavaFoldingPreferenceBlock#performDefaults()
	 */
	public void performDefaults() {
	}

	/*
	 * @see descent.internal.ui.text.folding.IJavaFoldingPreferenceBlock#dispose()
	 */
	public void dispose() {
	}
