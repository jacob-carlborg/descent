...
import descent.internal.ui.text.CombinedWordRule.WordMatcher;
...
public class JavaCommentScanner extends AbstractJavaScanner{
	...
	private class TaskTagMatcher extends CombinedWordRule.WordMatcher {
		...
		/*
		 * @see descent.internal.ui.text.CombinedWordRule.WordMatcher#clearWords()
		 * @since 3.0
		 */
		...
		/*
		 * @see descent.internal.ui.text.CombinedWordRule.WordMatcher#addWord(java.lang.String, org.eclipse.jface.text.rules.IToken)
		 * @since 3.0
		 */
	...
	/*
	 * @see descent.internal.ui.text.AbstractJavaScanner#affectsBehavior(org.eclipse.jface.util.PropertyChangeEvent)
	 */
	...
	/*
	 * @see descent.internal.ui.text.AbstractJavaScanner#adaptToPreferenceChange(org.eclipse.jface.util.PropertyChangeEvent)
	 */
	...
	/*
	 * @see descent.internal.ui.text.AbstractJavaScanner#getTokenProperties()
	 */
