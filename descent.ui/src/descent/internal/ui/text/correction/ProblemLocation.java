...
public class ProblemLocation implements IProblemLocation {
	...
	public ProblemLocation(IProblem problem) {
		...
		fMarkerType= problem.getMarkerType();
	}


	/* (non-Javadoc)
	 * @see descent.internal.ui.text.correction.IProblemLocation#getProblemId()
	 */
	...
	/* (non-Javadoc)
	 * @see descent.internal.ui.text.correction.IProblemLocation#getProblemArguments()
	 */
	...
	/* (non-Javadoc)
	 * @see descent.internal.ui.text.correction.IProblemLocation#getLength()
	 */
	...
	/* (non-Javadoc)
	 * @see descent.internal.ui.text.correction.IProblemLocation#getOffset()
	 */
	...
	/* (non-Javadoc)
	 * @see descent.ui.text.java.IProblemLocation#isError()
	 */
	...
	/* (non-Javadoc)
	 * @see descent.ui.text.java.IProblemLocation#getMarkerType()
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see descent.internal.ui.text.correction.IProblemLocation#getCoveringNode(descent.core.dom.CompilationUnit)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see descent.internal.ui.text.correction.IProblemLocation#getCoveredNode(descent.core.dom.CompilationUnit)
	 */
