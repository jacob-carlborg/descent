 ...
 * {@link descent.ui.text.java.IJavaCompletionProposalComputer}s contributed via the
 * <code>descent.ui.javaCompletionProposalComputer</code> extension point.
 * <p>
				...
				protected Control createCustomArea(Composite composite) {
	        		...
	        		link.addSelectionListener(new SelectionAdapter() {
	        			public void widgetSelected(SelectionEvent e) {
	        				close();
	        				PreferencesUtil.createPreferenceDialogOn(shell, "descent.ui.preferences.CodeAssistPreferenceAdvanced", null, null).open(); //$NON-NLS-1$
	        			}
	        		});
