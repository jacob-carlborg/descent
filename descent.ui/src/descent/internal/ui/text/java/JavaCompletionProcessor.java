...
public class JavaCompletionProcessor extends ContentAssistProcessor {
	...
	/*
	 * @see descent.internal.ui.text.java.ContentAssistProcessor#filterAndSort(java.util.List, org.eclipse.core.runtime.IProgressMonitor)
	 */
	...
	/*
	 * @see descent.internal.ui.text.java.ContentAssistProcessor#createContext(org.eclipse.jface.text.ITextViewer, int)
	 */
