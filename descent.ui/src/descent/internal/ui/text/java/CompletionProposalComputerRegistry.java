 ...
 * <code>descent.ui.javaCompletionProposalComputer</code>
 * extension point.
 * 
 * @since 3.2
 */
public final class CompletionProposalComputerRegistry {
	 ...
	 * {@link descent.ui.text.IJavaPartitions} or
	 ...
	 * contract of {@link descent.ui.text.java.IJavaCompletionProposalComputer}. When
        	...
        	protected Control createCustomArea(Composite parent) {
        		...
        		link.addSelectionListener(new SelectionAdapter() {
        			public void widgetSelected(SelectionEvent e) {
        				PreferencesUtil.createPreferenceDialogOn(getShell(), "descent.ui.preferences.CodeAssistPreferenceAdvanced", null, null).open(); //$NON-NLS-1$
        			}
        		});
