 ...
 */
public final class ExperimentalMethodProposal extends JavaMethodCompletionProposal {

	private IRegion fSelectedRegion; // initialized by apply()
	private int[] fArgumentOffsets;
	private int[] fArgumentLengths;

	public ExperimentalMethodProposal(CompletionProposal proposal, JavaContentAssistInvocationContext context) {
	...
	public void apply(IDocument document, char trigger, int offset) {
		...
		if (!mustInsertDot(trigger) && fProposal.wantArguments() && fArgumentOffsets != null && getTextViewer() != null && !isSetter() && !isGetter()) {
			try {
