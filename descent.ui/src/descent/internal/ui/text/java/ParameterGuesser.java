...
import descent.internal.ui.text.template.contentassist.PositionBasedCompletionProposal;
...
public class ParameterGuesser {
	...
	public ParameterGuesser(int codeAssistOffset, ICompilationUnit compilationUnit) {
		...
		fAllowAutoBoxing= false; // JavaCore.VERSION_1_5.compareTo(sourceVersion) <= 0;
	}
