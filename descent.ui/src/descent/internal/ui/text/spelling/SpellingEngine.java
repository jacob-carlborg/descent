...
import descent.internal.ui.text.spelling.engine.ISpellEvent;
...
public abstract class SpellingEngine implements ISpellingEngine {
	...
	protected static class SpellEventListener implements ISpellEventListener {
		...
		/*
		 * @see descent.internal.ui.text.spelling.engine.ISpellEventListener#handle(descent.internal.ui.text.spelling.engine.ISpellEvent)
		 */
