...
public class PropertiesSpellingReconcileStrategy implements IReconcilingStrategy, IReconcilingStrategyExtension {
	 ...
	 * {@link IProblem}s to the {@link descent.core.IProblemRequestor}.
	 */
	...
	public PropertiesSpellingReconcileStrategy(ITextEditor editor) {
		...
		fSpellingContext.setContentType(Platform.getContentTypeManager().getContentType("descent.core.javaProperties")); //$NON-NLS-1$
	}
