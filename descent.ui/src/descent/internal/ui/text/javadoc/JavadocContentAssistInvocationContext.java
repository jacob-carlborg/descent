...
public final class JavadocContentAssistInvocationContext extends JavaContentAssistInvocationContext {
	 ...
	 * @param offset
	 * @param editor
	 * @param flags see {@link descent.ui.text.java.IJavadocCompletionProcessor#RESTRICT_TO_MATCHING_CASE}
	 */
	 ...
	 * @see descent.ui.text.java.IJavadocCompletionProcessor#RESTRICT_TO_MATCHING_CASE
	 */
	public int getFlags() {
		return fFlags;
	}
