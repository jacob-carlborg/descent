...
import descent.internal.ui.search.JavaSearchResult.MatchFilterEvent;
...
public class JavaSearchResultPage extends AbstractTextSearchViewPage implements IAdaptable {
	...
	private static final String KEY_GROUPING= "descent.search.resultpage.grouping"; //$NON-NLS-1$
	private static final String KEY_SORTING= "descent.search.resultpage.sorting"; //$NON-NLS-1$
	private static final String KEY_LIMIT_ENABLED= "descent.search.resultpage.limit_enabled"; //$NON-NLS-1$
	private static final String KEY_LIMIT= "descent.search.resultpage.limit"; //$NON-NLS-1$
	
	private static final String GROUP_GROUPING= "descent.search.resultpage.grouping"; //$NON-NLS-1$
	private static final String GROUP_FILTERING = "descent.search.resultpage.filtering"; //$NON-NLS-1$
	...
	private void initFilterActions() {
		...
		for (int i= 0; i < fFilterActions.length; i++) {
			...
			fFilterActions[i].setId("descent.search.filters."+i); //$NON-NLS-1$
		}
		fFilterDialogAction= new FiltersDialogAction(this);
		fFilterDialogAction.setId("descent.search.filters."+allFilters.length); //$NON-NLS-1$
