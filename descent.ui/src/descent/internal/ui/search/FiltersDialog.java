...
public class FiltersDialog extends SelectionStatusDialog {
	...
	public FiltersDialog(JavaSearchResultPage page) {
		...
		setTitle(descent.internal.ui.search.SearchMessages.FiltersDialog_title); 
	...
	protected Control createDialogArea(Composite composite) {
		...
		l.setText(descent.internal.ui.search.SearchMessages.FiltersDialog_filters_label); 
		...
		l.setFont(parent.getFont());
		l.setText(descent.internal.ui.search.SearchMessages.FiltersDialog_description_label); 
	...
	private void createTableLimit(Composite ancestor) {
		...
		fLimitElementsCheckbox.setText(descent.internal.ui.search.SearchMessages.FiltersDialog_limit_label);  
	...
	protected void validateText() {
		...
		if (fLimitElementsCheckbox.getSelection() && value <= 0)
			updateStatus(new Status(IStatus.ERROR, JavaPlugin.getPluginId(), 0, descent.internal.ui.search.SearchMessages.FiltersDialog_limit_error, null)); 
		else
