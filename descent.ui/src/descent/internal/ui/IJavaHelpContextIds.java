...
public interface IJavaHelpContextIds {
	 ...
	 * @since 3.0
	 */
	public static final String CONFIG_CONTAINER_ACTION= 									PREFIX + "descent.ui.config_container_action"; //$NON-NLS-1$
	...
	public static final String DEBUG_CTFE_ACTION=				PREFIX + "debug_ctfe";	//$NON-NLS-1$
