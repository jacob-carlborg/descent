...
import descent.internal.ui.refactoring.MessageWizardPage;
...
public class DeleteWizard extends RefactoringWizard {
	...
	/* (non-Javadoc)
	 * @see descent.internal.ui.refactoring.RefactoringWizard#addUserInputPages()
	 */
	...
	/* (non-Javadoc)
	 * @see descent.internal.ui.refactoring.RefactoringWizard#getMessageLineWidthInChars()
	 */
	...
	private static class DeleteInputPage extends MessageWizardPage {
		...
		/* (non-Javadoc)
		 * @see descent.internal.ui.refactoring.RefactoringWizardPage#performFinish()
		 */
