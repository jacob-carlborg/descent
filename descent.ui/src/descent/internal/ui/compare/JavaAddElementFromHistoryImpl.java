...
class JavaAddElementFromHistoryImpl extends JavaHistoryActionImpl {
	...
	private static final String BUNDLE_NAME= "descent.internal.ui.compare.AddFromHistoryAction"; //$NON-NLS-1$
	...
	public void run(ISelection selection) {
		...
		try {
			...
			for (int i= 0; i < results.length; i++) {
				...
				if (newNode instanceof ModuleDeclaration) {
				    rewriter.set(root, CompilationUnit.MODULE_DECLARATION_PROPERTY, newNode, null);
