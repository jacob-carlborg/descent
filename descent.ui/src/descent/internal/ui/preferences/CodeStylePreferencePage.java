...
public class CodeStylePreferencePage extends PropertyAndPreferencePage implements IWorkbenchPreferencePage {
	...
	public static final String PREF_ID= "descent.ui.preferences.CodeStylePreferencePage"; //$NON-NLS-1$
	public static final String PROP_ID= "descent.ui.propertyPages.CodeStylePreferencePage"; //$NON-NLS-1$
