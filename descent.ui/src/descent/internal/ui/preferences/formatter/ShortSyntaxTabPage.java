...
public class ShortSyntaxTabPage extends ModifyDialogTabPage {
	...
	createPreviewHeader(FormatterMessages.ShortSyntaxTabPage_preview_header) +
	...
	public ShortSyntaxTabPage(ModifyDialog modifyDialog, Map workingValues) {
		super(modifyDialog, workingValues);
	}

	protected void doCreatePreferences(Composite composite, int numColumns) {

		final Group shortSyntaxGroup = createGroup(numColumns, composite, FormatterMessages.ShortSyntaxTabPage_short_syntax_group_title); 
		createCheckboxPref(shortSyntaxGroup, numColumns, 
				FormatterMessages.ShortSyntaxTabPage_keep_simple_then_declaration_on_same_line,
				DefaultCodeFormatterConstants.FORMATTER_KEEP_SIMPLE_THEN_DECLARATION_ON_SAME_LINE, FALSE_TRUE); 
		createCheckboxPref(shortSyntaxGroup, numColumns,
				FormatterMessages.ShortSyntaxTabPage_keep_simple_else_declaration_on_same_line,
				DefaultCodeFormatterConstants.FORMATTER_KEEP_SIMPLE_ELSE_DECLARATION_ON_SAME_LINE, FALSE_TRUE);
		createCheckboxPref(shortSyntaxGroup, numColumns,
				FormatterMessages.ShortSyntaxTabPage_keep_simple_then_statement_on_same_line,
				DefaultCodeFormatterConstants.FORMATTER_KEEP_SIMPLE_THEN_STATEMENT_ON_SAME_LINE, FALSE_TRUE); 
		createCheckboxPref(shortSyntaxGroup, numColumns,
				FormatterMessages.ShortSyntaxTabPage_keep_simple_else_statement_on_same_line,
				DefaultCodeFormatterConstants.FORMATTER_KEEP_SIMPLE_ELSE_STATEMENT_ON_SAME_LINE, FALSE_TRUE);
		createCheckboxPref(shortSyntaxGroup, numColumns,
				FormatterMessages.ShortSyntaxTabPage_keep_simple_try_statement_on_same_line,
				DefaultCodeFormatterConstants.FORMATTER_KEEP_SIMPLE_TRY_STATEMENT_ON_SAME_LINE, FALSE_TRUE); 
		createCheckboxPref(shortSyntaxGroup, numColumns,
				FormatterMessages.ShortSyntaxTabPage_keep_simple_catch_statement_on_same_line,
				DefaultCodeFormatterConstants.FORMATTER_KEEP_SIMPLE_CATCH_STATEMENT_ON_SAME_LINE,FALSE_TRUE); 
		createCheckboxPref(shortSyntaxGroup, numColumns,
				FormatterMessages.ShortSyntaxTabPage_keep_simple_finally_statement_on_same_line,
        ...
        createCheckboxPref(shortSyntaxGroup, numColumns,
        		FormatterMessages.ShortSyntaxTabPage_keep_simple_with_statement_on_same_line,
        		DefaultCodeFormatterConstants.FORMATTER_KEEP_SIMPLE_WITH_STATEMENT_ON_SAME_LINE, FALSE_TRUE);
        createCheckboxPref(shortSyntaxGroup, numColumns,
				FormatterMessages.ShortSyntaxTabPage_keep_functions_with_no_statement_in_one_line,
				DefaultCodeFormatterConstants.FORMATTER_KEEP_FUNCTIONS_WITH_NO_STATEMENT_IN_ONE_LINE, FALSE_TRUE); 
        createCheckboxPref(shortSyntaxGroup, numColumns,
        		FormatterMessages.ShortSyntaxTabPage_keep_functions_with_one_statement_in_one_line,
