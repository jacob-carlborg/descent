...
public final class WhiteSpaceOptions
{
	...
	{	
		...
		createOption(dynamic_arrays, workingValues, FormatterMessages.WhiteSpaceOptions_before_opening_bracket, DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACKET_IN_DYNAMIC_ARRAYS, ARRAYS_PREVIEW);
	...
	public List<Node> createTreeBySyntaxElement(Map<String, String> workingValues)
	{
		...
		createOption(before_opening_bracket, workingValues, FormatterMessages.WhiteSpaceOptions_dynamic_arrays, DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_BEFORE_OPENING_BRACKET_IN_DYNAMIC_ARRAYS, ARRAYS_PREVIEW);
