...
import descent.internal.ui.javaeditor.SemanticHighlighting;
import descent.internal.ui.javaeditor.SemanticHighlightingManager;
import descent.internal.ui.javaeditor.SemanticHighlightings;
import descent.internal.ui.javaeditor.SemanticHighlightingManager.HighlightedRange;
...
class JavaEditorColoringConfigurationBlock extends AbstractConfigurationBlock {
	...
	/*
	 * @see descent.internal.ui.preferences.IPreferenceConfigurationBlock#dispose()
	 */
	public void dispose() {
		uninstallSemanticHighlighting();
...
//					return 1;
	...
	private Control createPreviewer(Composite parent) {
		...
		configuration.handlePropertyChangeEvent(new PropertyChangeEvent(this, JavaCore.COMPILER_SOURCE, JavaCore.VERSION_1_x, JavaCore.VERSION_2_x));
