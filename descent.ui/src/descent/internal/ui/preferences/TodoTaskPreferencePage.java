...
public class TodoTaskPreferencePage extends PropertyAndPreferencePage {
	...
	public static final String PREF_ID= "descent.ui.preferences.TodoTaskPreferencePage"; //$NON-NLS-1$
	public static final String PROP_ID= "descent.ui.propertyPages.TodoTaskPreferencePage"; //$NON-NLS-1$
