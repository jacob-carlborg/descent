 ...
 *******************************************************************************/
package descent.internal.corext.refactoring.structure;
...
// TODO JDT UI search: it's a stub
public class ASTNodeSearchUtil {
	...
	public static Declaration getMethodDeclarationNode(IMethod iMethod, CompilationUnit cuNode) throws JavaModelException {
		// TODO JDT UI search: this is wrong since ConstructorDeclaration may be an IInitializer
		return (Declaration)ASTNodes.getParent(getNameNode(iMethod, cuNode), FunctionDeclaration.class, ConstructorDeclaration.class);
	}
	...
	*/
	...
	public static Declaration getMethodOrAnnotationTypeMemberDeclarationNode(IMethod iMethod, CompilationUnit cuNode) throws JavaModelException {
		return getMethodDeclarationNode(iMethod, cuNode);
	}

	public static ASTNode getFieldDeclarationFragmentNode(IField iField, CompilationUnit cuNode) throws JavaModelException {
		ASTNode node= getNameNode(iField, cuNode);
		if (node instanceof VariableDeclarationFragment ||
				node instanceof AliasDeclarationFragment ||
				node instanceof TypedefDeclarationFragment)
			return  (ASTNode)node;
		return (ASTNode) ASTNodes.getParent(node, VariableDeclarationFragment.class, AliasDeclarationFragment.class, TypedefDeclarationFragment.class);
	}
		
	public static VariableDeclaration getFieldDeclarationNode(IField iField, CompilationUnit cuNode) throws JavaModelException {
		return (VariableDeclaration) ASTNodes.getParent(getNameNode(iField, cuNode), VariableDeclaration.class, AliasDeclaration.class, TypedefDeclaration.class, MixinDeclaration.class);
	}

	public static EnumMember getEnumConstantDeclaration(IField iField, CompilationUnit cuNode) throws JavaModelException {
		return (EnumMember) ASTNodes.getParent(getNameNode(iField, cuNode), EnumMember.class);
	}

	public static ASTNode getFieldOrEnumConstantDeclaration(IField iField, CompilationUnit cuNode) throws JavaModelException {
	...
	*/
	...
	public static Declaration getAbstractTypeDeclarationNode(IType iType, CompilationUnit cuNode) throws JavaModelException {
		return (Declaration) ASTNodes.getParent(getNameNode(iType, cuNode), AggregateDeclaration.class, TemplateDeclaration.class, EnumDeclaration.class);
	}
	...
	*/
	...
	public static ModuleDeclaration getPackageDeclarationNode(IPackageDeclaration reference, CompilationUnit cuNode) throws JavaModelException {
		return (ModuleDeclaration) findNode(reference.getSourceRange(), cuNode);
	}
