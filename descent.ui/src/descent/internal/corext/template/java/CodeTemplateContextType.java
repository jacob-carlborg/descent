...
public class CodeTemplateContextType extends TemplateContextType {
	...
	private static final String CODETEMPLATES_PREFIX= "descent.ui.text.codetemplates."; //$NON-NLS-1$
	...
	/*
	 * @see descent.internal.corext.template.ContextType#validateVariables(descent.internal.corext.template.TemplateVariable[])
	 */
	...
	/* (non-Javadoc)
	 * @see descent.internal.corext.template.ContextType#createContext()
	 */
	...
	/*
	 * @see descent.internal.corext.template.ContextType#validate(java.lang.String)
	 */
	...
	private boolean isValidComment(String template) {
		...
		try {
			...
			while (next == ITerminalSymbols.TokenNameCOMMENT_LINE 
					|| next == ITerminalSymbols.TokenNameCOMMENT_PLUS 
					|| next == ITerminalSymbols.TokenNameCOMMENT_BLOCK
					|| next == ITerminalSymbols.TokenNameCOMMENT_DOC_LINE
					|| next == ITerminalSymbols.TokenNameCOMMENT_DOC_PLUS
					|| next == ITerminalSymbols.TokenNameCOMMENT_DOC_BLOCK) {
