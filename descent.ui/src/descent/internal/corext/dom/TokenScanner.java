...
public class TokenScanner {
	...
	public static boolean isComment(int token) {
		return token == ITerminalSymbols.TokenNameCOMMENT_BLOCK 
			|| token == ITerminalSymbols.TokenNameCOMMENT_PLUS 
			|| token == ITerminalSymbols.TokenNameCOMMENT_LINE
			|| token == ITerminalSymbols.TokenNameCOMMENT_DOC_BLOCK
			|| token == ITerminalSymbols.TokenNameCOMMENT_DOC_PLUS 
			|| token == ITerminalSymbols.TokenNameCOMMENT_DOC_LINE;
	}
