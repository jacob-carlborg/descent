...
public class JdtFlags {
	...
	*/
	...
	public static boolean isPackageVisible(Declaration bodyDeclaration) {
	...
	public static boolean isPrivate(Declaration bodyDeclaration) {
	...
	public static boolean isProtected(Declaration bodyDeclaration) {
	...
	public static boolean isPublic(Declaration bodyDeclaration) {
	...
	*/
	...
	private static boolean isInterfaceOrAnnotationMember(Declaration bodyDeclaration) {
		boolean isInterface= (bodyDeclaration.getParent() instanceof AggregateDeclaration) &&
				((AggregateDeclaration)bodyDeclaration.getParent()).getKind() == AggregateDeclaration.Kind.INTERFACE;
	...
	public static int getVisibilityCode(Declaration bodyDeclaration) {
