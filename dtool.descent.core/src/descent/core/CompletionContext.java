...
import descent.internal.codeassist.InternalCompletionContext;
import descent.internal.codeassist.complete.CompletionOnJavadoc;
...
public final class CompletionContext extends InternalCompletionContext {
	 ...
	 * <code>null</code> if there is no expected types.
	 * 
	 * @see descent.core.dom.ASTParser#createASTs(ICompilationUnit[], String[], descent.core.dom.ASTRequestor, org.eclipse.core.runtime.IProgressMonitor)
	 */
