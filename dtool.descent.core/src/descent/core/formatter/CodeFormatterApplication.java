...
public class CodeFormatterApplication implements IApplication {
	...
	private final static class Messages extends NLS {
		private static final String BUNDLE_NAME = "descent.core.formatter.messages";//$NON-NLS-1$
	...
	private void formatFile(File file, CodeFormatter codeFormatter) {
		...
		try {
			...
			String contents = new String(descent.internal.compiler.util.Util.getFileCharContent(file, null));
