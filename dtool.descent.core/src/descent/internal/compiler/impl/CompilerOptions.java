...
public class CompilerOptions {
	 ...
	 * Option IDs
	 */
	public static final String OPTION_LocalVariableAttribute = "descent.core.compiler.debug.localVariable"; //$NON-NLS-1$
	public static final String OPTION_LineNumberAttribute = "descent.core.compiler.debug.lineNumber"; //$NON-NLS-1$
	public static final String OPTION_SourceFileAttribute = "descent.core.compiler.debug.sourceFile"; //$NON-NLS-1$
	public static final String OPTION_PreserveUnusedLocal = "descent.core.compiler.codegen.unusedLocal"; //$NON-NLS-1$
	public static final String OPTION_DocCommentSupport= "descent.core.compiler.doc.comment.support"; //$NON-NLS-1$
	public static final String OPTION_ReportMethodWithConstructorName = "descent.core.compiler.problem.methodWithConstructorName"; //$NON-NLS-1$
	public static final String OPTION_ReportOverridingPackageDefaultMethod = "descent.core.compiler.problem.overridingPackageDefaultMethod"; //$NON-NLS-1$
	public static final String OPTION_ReportDeprecation = "descent.core.compiler.problem.deprecation"; //$NON-NLS-1$
	public static final String OPTION_ReportDeprecationInDeprecatedCode = "descent.core.compiler.problem.deprecationInDeprecatedCode"; //$NON-NLS-1$
	public static final String OPTION_ReportDeprecationWhenOverridingDeprecatedMethod = "descent.core.compiler.problem.deprecationWhenOverridingDeprecatedMethod"; //$NON-NLS-1$
	public static final String OPTION_ReportHiddenCatchBlock = "descent.core.compiler.problem.hiddenCatchBlock"; //$NON-NLS-1$
	public static final String OPTION_ReportUnusedLocal = "descent.core.compiler.problem.unusedLocal"; //$NON-NLS-1$
	public static final String OPTION_ReportUnusedParameter = "descent.core.compiler.problem.unusedParameter"; //$NON-NLS-1$
	public static final String OPTION_ReportUnusedParameterWhenImplementingAbstract = "descent.core.compiler.problem.unusedParameterWhenImplementingAbstract"; //$NON-NLS-1$
	public static final String OPTION_ReportUnusedParameterWhenOverridingConcrete = "descent.core.compiler.problem.unusedParameterWhenOverridingConcrete"; //$NON-NLS-1$
	public static final String OPTION_ReportUnusedImport = "descent.core.compiler.problem.unusedImport"; //$NON-NLS-1$
	public static final String OPTION_ReportSyntheticAccessEmulation = "descent.core.compiler.problem.syntheticAccessEmulation"; //$NON-NLS-1$
	public static final String OPTION_ReportNoEffectAssignment = "descent.core.compiler.problem.noEffectAssignment"; //$NON-NLS-1$
	public static final String OPTION_ReportLocalVariableHiding = "descent.core.compiler.problem.localVariableHiding"; //$NON-NLS-1$
	public static final String OPTION_ReportSpecialParameterHidingField = "descent.core.compiler.problem.specialParameterHidingField"; //$NON-NLS-1$
	public static final String OPTION_ReportFieldHiding = "descent.core.compiler.problem.fieldHiding"; //$NON-NLS-1$
	public static final String OPTION_ReportTypeParameterHiding = "descent.core.compiler.problem.typeParameterHiding"; //$NON-NLS-1$
	public static final String OPTION_ReportPossibleAccidentalBooleanAssignment = "descent.core.compiler.problem.possibleAccidentalBooleanAssignment"; //$NON-NLS-1$
	public static final String OPTION_ReportNonExternalizedStringLiteral = "descent.core.compiler.problem.nonExternalizedStringLiteral"; //$NON-NLS-1$
	public static final String OPTION_ReportIncompatibleNonInheritedInterfaceMethod = "descent.core.compiler.problem.incompatibleNonInheritedInterfaceMethod"; //$NON-NLS-1$
	public static final String OPTION_ReportUnusedPrivateMember = "descent.core.compiler.problem.unusedPrivateMember"; //$NON-NLS-1$
	public static final String OPTION_ReportNoImplicitStringConversion = "descent.core.compiler.problem.noImplicitStringConversion"; //$NON-NLS-1$
	public static final String OPTION_ReportAssertIdentifier = "descent.core.compiler.problem.assertIdentifier"; //$NON-NLS-1$
	public static final String OPTION_ReportEnumIdentifier = "descent.core.compiler.problem.enumIdentifier"; //$NON-NLS-1$
	public static final String OPTION_ReportNonStaticAccessToStatic = "descent.core.compiler.problem.staticAccessReceiver"; //$NON-NLS-1$
	public static final String OPTION_ReportIndirectStaticAccess = "descent.core.compiler.problem.indirectStaticAccess"; //$NON-NLS-1$
	public static final String OPTION_ReportEmptyStatement = "descent.core.compiler.problem.emptyStatement"; //$NON-NLS-1$
	public static final String OPTION_ReportUnnecessaryTypeCheck = "descent.core.compiler.problem.unnecessaryTypeCheck"; //$NON-NLS-1$
	public static final String OPTION_ReportUnnecessaryElse = "descent.core.compiler.problem.unnecessaryElse"; //$NON-NLS-1$
	public static final String OPTION_ReportUndocumentedEmptyBlock = "descent.core.compiler.problem.undocumentedEmptyBlock"; //$NON-NLS-1$
	public static final String OPTION_ReportInvalidJavadoc = "descent.core.compiler.problem.invalidJavadoc"; //$NON-NLS-1$
	public static final String OPTION_ReportInvalidJavadocTags = "descent.core.compiler.problem.invalidJavadocTags"; //$NON-NLS-1$
	public static final String OPTION_ReportInvalidJavadocTagsDeprecatedRef = "descent.core.compiler.problem.invalidJavadocTagsDeprecatedRef"; //$NON-NLS-1$
	public static final String OPTION_ReportInvalidJavadocTagsNotVisibleRef = "descent.core.compiler.problem.invalidJavadocTagsNotVisibleRef"; //$NON-NLS-1$
	public static final String OPTION_ReportInvalidJavadocTagsVisibility = "descent.core.compiler.problem.invalidJavadocTagsVisibility"; //$NON-NLS-1$
	public static final String OPTION_ReportMissingJavadocTags = "descent.core.compiler.problem.missingJavadocTags"; //$NON-NLS-1$
	public static final String OPTION_ReportMissingJavadocTagsVisibility = "descent.core.compiler.problem.missingJavadocTagsVisibility"; //$NON-NLS-1$
	public static final String OPTION_ReportMissingJavadocTagsOverriding = "descent.core.compiler.problem.missingJavadocTagsOverriding"; //$NON-NLS-1$
	public static final String OPTION_ReportMissingJavadocComments = "descent.core.compiler.problem.missingJavadocComments"; //$NON-NLS-1$
	public static final String OPTION_ReportMissingJavadocCommentsVisibility = "descent.core.compiler.problem.missingJavadocCommentsVisibility"; //$NON-NLS-1$
	public static final String OPTION_ReportMissingJavadocCommentsOverriding = "descent.core.compiler.problem.missingJavadocCommentsOverriding"; //$NON-NLS-1$
	public static final String OPTION_ReportFinallyBlockNotCompletingNormally = "descent.core.compiler.problem.finallyBlockNotCompletingNormally"; //$NON-NLS-1$
	public static final String OPTION_ReportUnusedDeclaredThrownException = "descent.core.compiler.problem.unusedDeclaredThrownException"; //$NON-NLS-1$
	public static final String OPTION_ReportUnusedDeclaredThrownExceptionWhenOverriding = "descent.core.compiler.problem.unusedDeclaredThrownExceptionWhenOverriding"; //$NON-NLS-1$
	public static final String OPTION_ReportUnqualifiedFieldAccess = "descent.core.compiler.problem.unqualifiedFieldAccess"; //$NON-NLS-1$
	public static final String OPTION_ReportUncheckedTypeOperation = "descent.core.compiler.problem.uncheckedTypeOperation"; //$NON-NLS-1$
	public static final String OPTION_ReportRawTypeReference =  "descent.core.compiler.problem.rawTypeReference"; //$NON-NLS-1$
	public static final String OPTION_ReportFinalParameterBound = "descent.core.compiler.problem.finalParameterBound"; //$NON-NLS-1$
	public static final String OPTION_ReportMissingSerialVersion = "descent.core.compiler.problem.missingSerialVersion"; //$NON-NLS-1$
	public static final String OPTION_ReportVarargsArgumentNeedCast = "descent.core.compiler.problem.varargsArgumentNeedCast"; //$NON-NLS-1$
	public static final String OPTION_Source = "descent.core.compiler.source"; //$NON-NLS-1$
	public static final String OPTION_TargetPlatform = "descent.core.compiler.codegen.targetPlatform"; //$NON-NLS-1$
	public static final String OPTION_Compliance = "descent.core.compiler.compliance"; //$NON-NLS-1$
	public static final String OPTION_Encoding = "descent.core.encoding"; //$NON-NLS-1$
	public static final String OPTION_MaxProblemPerUnit = "descent.core.compiler.maxProblemPerUnit"; //$NON-NLS-1$
	public static final String OPTION_TaskTags = "descent.core.compiler.taskTags"; //$NON-NLS-1$
	public static final String OPTION_TaskPriorities = "descent.core.compiler.taskPriorities"; //$NON-NLS-1$
	public static final String OPTION_TaskCaseSensitive = "descent.core.compiler.taskCaseSensitive"; //$NON-NLS-1$
	public static final String OPTION_InlineJsr = "descent.core.compiler.codegen.inlineJsrBytecode"; //$NON-NLS-1$
	public static final String OPTION_ReportNullReference = "descent.core.compiler.problem.nullReference"; //$NON-NLS-1$
	public static final String OPTION_ReportAutoboxing = "descent.core.compiler.problem.autoboxing"; //$NON-NLS-1$
	public static final String OPTION_ReportAnnotationSuperInterface = "descent.core.compiler.problem.annotationSuperInterface"; //$NON-NLS-1$
	public static final String OPTION_ReportMissingOverrideAnnotation = "descent.core.compiler.problem.missingOverrideAnnotation"; //$NON-NLS-1$
	public static final String OPTION_ReportMissingDeprecatedAnnotation = "descent.core.compiler.problem.missingDeprecatedAnnotation"; //$NON-NLS-1$
	public static final String OPTION_ReportIncompleteEnumSwitch = "descent.core.compiler.problem.incompleteEnumSwitch"; //$NON-NLS-1$
	public static final String OPTION_ReportForbiddenReference =  "descent.core.compiler.problem.forbiddenReference"; //$NON-NLS-1$
	public static final String OPTION_ReportDiscouragedReference =  "descent.core.compiler.problem.discouragedReference"; //$NON-NLS-1$
	public static final String OPTION_SuppressWarnings =  "descent.core.compiler.problem.suppressWarnings"; //$NON-NLS-1$
	public static final String OPTION_ReportUnhandledWarningToken =  "descent.core.compiler.problem.unhandledWarningToken"; //$NON-NLS-1$
	public static final String OPTION_ReportUnusedLabel =  "descent.core.compiler.problem.unusedLabel"; //$NON-NLS-1$
	public static final String OPTION_FatalOptionalError =  "descent.core.compiler.problem.fatalOptionalError"; //$NON-NLS-1$
	public static final String OPTION_ReportParameterAssignment =  "descent.core.compiler.problem.parameterAssignment"; //$NON-NLS-1$
	public static final String OPTION_ReportFallthroughCase =  "descent.core.compiler.problem.fallthroughCase"; //$NON-NLS-1$
	
	// Backward compatibility
	public static final String OPTION_ReportInvalidAnnotation = "descent.core.compiler.problem.invalidAnnotation"; //$NON-NLS-1$
	public static final String OPTION_ReportMissingAnnotation = "descent.core.compiler.problem.missingAnnotation"; //$NON-NLS-1$
	public static final String OPTION_ReportMissingJavadoc = "descent.core.compiler.problem.missingJavadoc"; //$NON-NLS-1$
	 ...
	 */
	public static final long MethodWithConstructorName = ASTNodeFromJdt.Bit1;
	public static final long OverriddenPackageDefaultMethod = ASTNodeFromJdt.Bit2;
	public static final long UsingDeprecatedAPI = ASTNodeFromJdt.Bit3;
	public static final long MaskedCatchBlock = ASTNodeFromJdt.Bit4;
	public static final long UnusedLocalVariable = ASTNodeFromJdt.Bit5;
	public static final long UnusedArgument = ASTNodeFromJdt.Bit6;
	public static final long NoImplicitStringConversion = ASTNodeFromJdt.Bit7;
	public static final long AccessEmulation = ASTNodeFromJdt.Bit8;
	public static final long NonExternalizedString = ASTNodeFromJdt.Bit9;
	public static final long AssertUsedAsAnIdentifier = ASTNodeFromJdt.Bit10;
	public static final long UnusedImport = ASTNodeFromJdt.Bit11;
	public static final long NonStaticAccessToStatic = ASTNodeFromJdt.Bit12;
	public static final long Task = ASTNodeFromJdt.Bit13;
	public static final long NoEffectAssignment = ASTNodeFromJdt.Bit14;
	public static final long IncompatibleNonInheritedInterfaceMethod = ASTNodeFromJdt.Bit15;
	public static final long UnusedPrivateMember = ASTNodeFromJdt.Bit16;
	public static final long LocalVariableHiding = ASTNodeFromJdt.Bit17;
	public static final long FieldHiding = ASTNodeFromJdt.Bit18;
	public static final long AccidentalBooleanAssign = ASTNodeFromJdt.Bit19;
	public static final long EmptyStatement = ASTNodeFromJdt.Bit20;
	public static final long MissingJavadocComments  = ASTNodeFromJdt.Bit21;
	public static final long MissingJavadocTags = ASTNodeFromJdt.Bit22;
	public static final long UnqualifiedFieldAccess = ASTNodeFromJdt.Bit23;
	public static final long UnusedDeclaredThrownException = ASTNodeFromJdt.Bit24;
	public static final long FinallyBlockNotCompleting = ASTNodeFromJdt.Bit25;
	public static final long InvalidJavadoc = ASTNodeFromJdt.Bit26;
	public static final long UnnecessaryTypeCheck = ASTNodeFromJdt.Bit27;
	public static final long UndocumentedEmptyBlock = ASTNodeFromJdt.Bit28;
	public static final long IndirectStaticAccess = ASTNodeFromJdt.Bit29;
	public static final long UnnecessaryElse  = ASTNodeFromJdt.Bit30;
	public static final long UncheckedTypeOperation = ASTNodeFromJdt.Bit31;
	public static final long FinalParameterBound = ASTNodeFromJdt.Bit32L;
	public static final long MissingSerialVersion = ASTNodeFromJdt.Bit33L;
	public static final long EnumUsedAsAnIdentifier = ASTNodeFromJdt.Bit34L;	
	public static final long ForbiddenReference = ASTNodeFromJdt.Bit35L;
	public static final long VarargsArgumentNeedCast = ASTNodeFromJdt.Bit36L;
	public static final long NullReference = ASTNodeFromJdt.Bit37L;
	public static final long AutoBoxing = ASTNodeFromJdt.Bit38L;
	public static final long AnnotationSuperInterface = ASTNodeFromJdt.Bit39L;
	public static final long TypeParameterHiding = ASTNodeFromJdt.Bit40L;
	public static final long MissingOverrideAnnotation = ASTNodeFromJdt.Bit41L;
	public static final long IncompleteEnumSwitch = ASTNodeFromJdt.Bit42L;
	public static final long MissingDeprecatedAnnotation = ASTNodeFromJdt.Bit43L;
	public static final long DiscouragedReference = ASTNodeFromJdt.Bit44L;
	public static final long UnhandledWarningToken = ASTNodeFromJdt.Bit45L;
	public static final long RawTypeReference = ASTNodeFromJdt.Bit46L;
	public static final long UnusedLabel = ASTNodeFromJdt.Bit47L;
	public static final long ParameterAssignment = ASTNodeFromJdt.Bit48L;
	public static final long FallthroughCase = ASTNodeFromJdt.Bit49L;
	...
	public int produceDebugAttributes = 0; // ClassFileConstants.ATTR_SOURCE | ClassFileConstants.ATTR_LINES;

	public long complianceLevel = 0; // ClassFileConstants.JDK1_4; // by default be compliant with 1.4
	public long sourceLevel = 0; // ClassFileConstants.JDK1_3; //1.3 source behavior by default
	public long targetJDK = 0; // ClassFileConstants.JDK1_2; // default generates for JVM1.2
	...
	public int reportInvalidJavadocTagsVisibility = Flags.AccPublic; 
	...
	public int reportMissingJavadocTagsVisibility = Flags.AccPublic; 
	public boolean reportMissingJavadocTagsOverriding = false;

	// check missing javadoc comments
	public int reportMissingJavadocCommentsVisibility = Flags.AccPublic; 
	...
	public Map getMap() {
		...
		//optionsMap.put(OPTION_LocalVariableAttribute, (this.produceDebugAttributes & Flags.ATTR_VARS) != 0 ? GENERATE : DO_NOT_GENERATE); 
		//optionsMap.put(OPTION_LineNumberAttribute, (this.produceDebugAttributes & Flags.ATTR_LINES) != 0 ? GENERATE : DO_NOT_GENERATE);
		//optionsMap.put(OPTION_SourceFileAttribute, (this.produceDebugAttributes & Flags.ATTR_SOURCE) != 0 ? GENERATE : DO_NOT_GENERATE);
	...
	public void set(Map optionsMap) {
		...
		if ((optionValue = optionsMap.get(OPTION_LocalVariableAttribute)) != null) {
			...
			if (GENERATE.equals(optionValue)) {
				this.produceDebugAttributes |= Flags.ATTR_VARS;
		...
		if ((optionValue = optionsMap.get(OPTION_LineNumberAttribute)) != null) {
			/*
			if (GENERATE.equals(optionValue)) {
				this.produceDebugAttributes |= Flags.ATTR_LINES;
			} else if (DO_NOT_GENERATE.equals(optionValue)) {
				this.produceDebugAttributes &= ~Flags.ATTR_LINES;
			}
			*/
		...
		if ((optionValue = optionsMap.get(OPTION_SourceFileAttribute)) != null) {
			/*
			if (GENERATE.equals(optionValue)) {
				this.produceDebugAttributes |= Flags.ATTR_SOURCE;
			} else if (DO_NOT_GENERATE.equals(optionValue)) {
				this.produceDebugAttributes &= ~Flags.ATTR_SOURCE;
			}
			*/
		...
		if ((optionValue = optionsMap.get(OPTION_TargetPlatform)) != null) {
			...
			// if (this.targetJDK >= Flags.JDK1_5) this.inlineJsrBytecode = true; // forced in 1.5 mode
		}
		...
		if ((optionValue = optionsMap.get(OPTION_InlineJsr)) != null) {
			/*
			if (this.targetJDK < Flags.JDK1_5) { // only optional if target < 1.5 (inlining on from 1.5 on)
				if (ENABLED.equals(optionValue)) {
		...
		if ( (optionValue = optionsMap.get(OPTION_ReportInvalidJavadocTagsVisibility)) != null) {
			if (PUBLIC.equals(optionValue)) {
				this.reportInvalidJavadocTagsVisibility = Flags.AccPublic;
			} else if (PROTECTED.equals(optionValue)) {
				this.reportInvalidJavadocTagsVisibility = Flags.AccProtected;
			} else if (DEFAULT.equals(optionValue)) {
				this.reportInvalidJavadocTagsVisibility = Flags.AccDefault;
			} else if (PRIVATE.equals(optionValue)) {
				this.reportInvalidJavadocTagsVisibility = Flags.AccPrivate;
			}
		}
		...
		if ((optionValue = optionsMap.get(OPTION_ReportMissingJavadocTagsVisibility)) != null) {
			if (PUBLIC.equals(optionValue)) {
				this.reportMissingJavadocTagsVisibility = Flags.AccPublic;
			} else if (PROTECTED.equals(optionValue)) {
				this.reportMissingJavadocTagsVisibility = Flags.AccProtected;
			} else if (DEFAULT.equals(optionValue)) {
				this.reportMissingJavadocTagsVisibility = Flags.AccDefault;
			} else if (PRIVATE.equals(optionValue)) {
				this.reportMissingJavadocTagsVisibility = Flags.AccPrivate;
			}
		}
		...
		if ((optionValue = optionsMap.get(OPTION_ReportMissingJavadocCommentsVisibility)) != null) {
			if (PUBLIC.equals(optionValue)) {
				this.reportMissingJavadocCommentsVisibility = Flags.AccPublic;
			} else if (PROTECTED.equals(optionValue)) {
				this.reportMissingJavadocCommentsVisibility = Flags.AccProtected;
			} else if (DEFAULT.equals(optionValue)) {
				this.reportMissingJavadocCommentsVisibility = Flags.AccDefault;
			} else if (PRIVATE.equals(optionValue)) {
				this.reportMissingJavadocCommentsVisibility = Flags.AccPrivate;
			}
		}
	...
	public String toString() {
		...
		//buf.append("\n\t- local variables debug attributes: ").append((this.produceDebugAttributes & Flags.ATTR_VARS) != 0 ? "ON" : " OFF"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		//buf.append("\n\t- line number debug attributes: ").append((this.produceDebugAttributes & Flags.ATTR_LINES) != 0 ? "ON" : " OFF"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		//buf.append("\n\t- source debug attributes: ").append((this.produceDebugAttributes & Flags.ATTR_SOURCE) != 0 ? "ON" : " OFF"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
