...
public class ListRewriteEvent extends RewriteEvent {
	...
	/* (non-Javadoc)
	 * @see descent.internal.corext.dom.ASTRewriteChange#getChangeKind()
	 */
	...
	/* (non-Javadoc)
	 * @see descent.internal.corext.dom.ASTRewriteChange#isListChange()
	 */
	...
	/* (non-Javadoc)
	 * @see descent.internal.corext.dom.RewriteEvent#getOriginalNode()
	 */
	...
	/* (non-Javadoc)
	 * @see descent.internal.corext.dom.RewriteEvent#getNewValue()
	 */
