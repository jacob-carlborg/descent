 ...
 *
 * @see descent.internal.core.util.ILRUCacheable
 */
public class LRUCache implements Cloneable {
	 ...
	 */
	protected Hashtable<Object, Object> fEntryTable;
	...
	public LRUCache(int size) {
		...
		fEntryTable = new Hashtable<Object, Object>(size);
		fSpaceLimit = size;
	}
	/**
	...
	public void flush() {
		...
		fEntryTable = new Hashtable<Object, Object>();  // Clear it out
		fEntryQueue = fEntryQueueTail = null;  
	...
	protected String toStringContents() {
		...
		for (int i = 0; i < length; i++) {
			...
			unsortedKeys[i] = key;
			unsortedToStrings[i] = 
				(key instanceof descent.internal.core.JavaElement) ?
					((descent.internal.core.JavaElement)key).getElementName() :
					key.toString();
		}
