...
public class DdocMacros {
	...
	static {
		...
		map.put("D_COMMENT", "<span class=\"" + IDeeDocColorConstants.JAVA_SINGLE_LINE_COMMENT + "\">$0</span>"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		map.put("D_STRING", "<span class=\"" + IDeeDocColorConstants.JAVA_STRING + "\">$0</span>"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
		map.put("D_KEYWORD", "<span class=\"" + IDeeDocColorConstants.JAVA_KEYWORD + "\">$0</span>"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
