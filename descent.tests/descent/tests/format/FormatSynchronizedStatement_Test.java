...
public class FormatSynchronizedStatement_Test extends AbstractFormatBraceWithSingleInsideFunction_Test {
	...
	protected Map getDefaultOptions() {
		...
		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_SYNCHRONIZED_STATEMENT, DefaultCodeFormatterConstants.FALSE);
		return options;
	}
	...
	public void testINSERT_SPACE_AFTER_OPENING_PAREN_IN_SYNCHRONIZED_STATEMENT() throws Exception {
		Map options = new HashMap();
		options.put(DefaultCodeFormatterConstants.FORMATTER_INSERT_SPACE_AFTER_OPENING_PAREN_IN_SYNCHRONIZED_STATEMENT, DefaultCodeFormatterConstants.TRUE);
		assertFormat(
				"synchronized( this) {\r\n" +
				"}\r\n",
