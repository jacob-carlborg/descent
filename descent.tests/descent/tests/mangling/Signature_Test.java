...
public class Signature_Test extends AbstractSignatureTest implements ISignatureConstants {
	...
	public void testStaticArray() {
		assertEquals(new TypeSArray(TypeBasic.tint32, new IntegerExp(3)).getSignature(), 
	...
	public void testStaticArray3() {
		assertEquals(new TypeSArray(TypeBasic.tint32, new IntegerExp(123)).getSignature(), 
	...
	public void testTypeof() {
		assertEquals(new TypeTypeof(Loc.ZERO, new IntegerExp(3)).getSignature(), 
	...
	public void testSlice() {
		assertEquals(new TypeSlice(TypeBasic.tint32, new IntegerExp(1), new IntegerExp(23)).getSignature(), 
