...
public class Parser extends Lexer {
	...
	*/
	...
	{   Expression e = null;
		...
		case TOKfloat32v: e = new RealExp(token.string, token.floatValue, Type.tfloat32); e.setSourceRange(token.ptr, token.len); nextToken(); break;
		case TOKfloat64v: e = new RealExp(token.string, token.floatValue, Type.tfloat64); e.setSourceRange(token.ptr, token.len); nextToken(); break;
		case TOKfloat80v: e = new RealExp(token.string, token.floatValue, Type.tfloat80); e.setSourceRange(token.ptr, token.len); nextToken(); break;
		case TOKimaginary32v: e = new RealExp(token.string, token.floatValue, Type.timaginary32); e.setSourceRange(token.ptr, token.len); nextToken(); break;
		case TOKimaginary64v: e = new RealExp(token.string, token.floatValue, Type.timaginary64); e.setSourceRange(token.ptr, token.len); nextToken(); break;
		case TOKimaginary80v: e = new RealExp(token.string, token.floatValue, Type.timaginary80); e.setSourceRange(token.ptr, token.len); nextToken(); break;
