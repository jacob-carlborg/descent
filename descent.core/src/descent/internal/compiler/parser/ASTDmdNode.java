...
public abstract class ASTDmdNode extends ASTNode {
	...
	// These are comments, not just ddocs
	public List<Comment> preComments;
	public Comment postComment;
	
	public List<Modifier> modifiers;
	public List<Modifier> extraModifiers; // Modifiers assigned from out parent, to better report problems
	
	
	/**
	 * If true, the node was generated by the compiler and not by
	 * the parser.
	 */
