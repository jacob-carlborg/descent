...
import descent.internal.core.util.ResourceCompilationUnit;
...
public abstract class HierarchyBuilder {
	...
	public HierarchyBuilder(TypeHierarchy hierarchy) throws JavaModelException {
		...
		descent.core.ICompilationUnit unitToLookInside = focusType == null ? null : focusType.getCompilationUnit();
		descent.core.ICompilationUnit[] workingCopies = this.hierarchy.workingCopies;
		descent.core.ICompilationUnit[] unitsToLookInside;
...
//	} catch (descent.internal.compiler.classfmt.ClassFormatException e) {
//		if (TypeHierarchy.DEBUG) {
//			e.printStackTrace();
//		}
//		return null;
...
//		info = descent.internal.compiler.classfmt.ClassFileReader.read(
//			zipFile,
//			classFilePath);
//	} catch (descent.internal.compiler.classfmt.ClassFormatException e) {
//		if (TypeHierarchy.DEBUG) {
