...
public class ArrayLiteral extends Expression implements IArrayLiteralExpression {
	...
	public static final ChildListPropertyDescriptor EXPRESSIONS_PROPERTY =
		new ChildListPropertyDescriptor(ArrayLiteral.class, "expressions", Expression.class, CYCLE_RISK); //$NON-NLS-1$
