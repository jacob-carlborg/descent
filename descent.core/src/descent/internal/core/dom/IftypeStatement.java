...
import descent.core.dom.IIftypeStatement;
import descent.internal.core.dom.IftypeDeclaration.Kind;
 ...
 * </pre>
 */
public class IftypeStatement extends Statement implements IIftypeStatement {
	...
	public static final ChildPropertyDescriptor THEN_BODY_PROPERTY =
		new ChildPropertyDescriptor(IftypeStatement.class, "thenBody", Statement.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$

	/**
	 * The "elseBody" structural property of this node type.
	 */
	public static final ChildPropertyDescriptor ELSE_BODY_PROPERTY =
		new ChildPropertyDescriptor(IftypeStatement.class, "elseBody", Statement.class, OPTIONAL, CYCLE_RISK); //$NON-NLS-1$
	...
	/**
	 * Returns the then body of this iftype statement.
	 * 
	...
	/**
	 * Sets the then body of this iftype statement.
	 * 
	...
	/**
	 * Returns the else body of this iftype statement.
	 * 
	...
	/**
	 * Sets the else body of this iftype statement.
	 * 
