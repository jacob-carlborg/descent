...
//		 TODO JDT import rewrite
	...
	private int getPackageStatementEndPos(CompilationUnit root) {
		ModuleDeclaration packDecl= root.getModuleDeclaration();
		if (packDecl != null) {
...
//			return this.elementName;
	...
	private final static class PackageEntry {
		...
		/**
		 * @param name Name of the package entry. e.g. descent.ui, containing imports like
		 * descent.ui.JavaUI.
