...
/*
 * @see descent.core.IPackageFragmentRoot#delete
 */
public void delete(
...
/*
 * @see descent.core.IPackageFragmentRoot#copy
 */
public void copy(
	IPath destination,
	int updateResourceFlags,
			...
			if (entry != null){
				...
				if (target instanceof IResource) {
					if (target instanceof IFile) {
						...
						if (descent.internal.compiler.util.Util.isArchiveFileName(file.getName())){
							return entry;
						}
...
/*
 * @see descent.core.IPackageFragmentRoot#move
 */
public void move(
	IPath destination,
	int updateResourceFlags,
