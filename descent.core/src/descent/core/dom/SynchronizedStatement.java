 ...
 *    <b>synchronized</b> [ <b>(</b> Expression <b>)</b> ] Statement
 * </pre>
 */
public class SynchronizedStatement extends Statement {
	...
	public static final ChildPropertyDescriptor EXPRESSION_PROPERTY =
		new ChildPropertyDescriptor(SynchronizedStatement.class, "expression", Expression.class, OPTIONAL, CYCLE_RISK); //$NON-NLS-1$

	/**
	 * The "body" structural property of this node type.
	 */
	public static final ChildPropertyDescriptor BODY_PROPERTY =
		new ChildPropertyDescriptor(SynchronizedStatement.class, "body", Statement.class, MANDATORY, CYCLE_RISK); //$NON-NLS-1$
	...
	static {
		...
		createPropertyList(SynchronizedStatement.class, properyList);
