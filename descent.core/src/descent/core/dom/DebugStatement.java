 ...
 * </pre>
 */
public class DebugStatement extends ConditionalStatement {
	...
	public static final ChildPropertyDescriptor THEN_BODY_PROPERTY =
		internalThenBodyPropertyFactory(DebugStatement.class); //$NON-NLS-1$

	/**
	 * The "elseBody" structural property of this node type.
	 */
	public static final ChildPropertyDescriptor ELSE_BODY_PROPERTY =
		internalElseBodyPropertyFactory(DebugStatement.class); //$NON-NLS-1$
