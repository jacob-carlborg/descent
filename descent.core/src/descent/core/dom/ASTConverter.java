...
public class ASTConverter {
	...
	public descent.core.dom.CatchClause convert(Catch a) {
		...
		if (a.sourceHandler != null) {
			descent.core.dom.Statement convertedHandler = convert(a.sourceHandler);
	...
	public descent.core.dom.Modifier convert(descent.internal.compiler.parser.Modifier a) {
		...
		case TOKshared: b.setModifierKeyword(descent.core.dom.Modifier.ModifierKeyword.SHARED_KEYWORD); break;		
		case TOKgshared: b.setModifierKeyword(descent.core.dom.Modifier.ModifierKeyword.GSHARED_KEYWORD); break;
		default:
