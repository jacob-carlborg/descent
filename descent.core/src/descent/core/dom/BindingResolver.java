...
class BindingResolver {
	...
	/**
	 * Resolves the given template declaration and returns the binding
	 * for it.
	 * <p>
	 * The implementation of <code>TemplateDeclaration.resolveBinding</code> 
	 * forwards to this method. How the declaration resolves is often a 
	 * function of the context in which the declaration node is embedded as well
	 * as the declaration subtree itself.
	 * </p>
	 ...
	 *    if no binding is available
	 */
	ITypeBinding resolveTemplate(TemplateDeclaration type) {
		return null;
	}
