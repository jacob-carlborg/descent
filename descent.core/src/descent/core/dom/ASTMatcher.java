...
public class ASTMatcher {
	 ...
	 *   different node type or is <code>null</code>
	 */
	public boolean match(AliasThisDeclaration node, Object other) {
		if (!(other instanceof AliasThisDeclaration)) {
			return false;
		}
		AliasThisDeclaration o = (AliasThisDeclaration) other;
		return (
			safeSubtreeListMatch(node.preDDocs(), o.preDDocs())
			&& safeSubtreeListMatch(node.modifiers(), o.modifiers())
			&& safeSubtreeMatch(node.getName(), o.getName())
	...
	public boolean match(FunctionDeclaration node, Object other) {
		...
		return (
			...
			&& safeSubtreeMatch(node.getConstraint(), o.getConstraint())
	 ...
	 *   different node type or is <code>null</code>
	 */
	public boolean match(TypeofReturn node, Object other) {
		if (!(other instanceof TypeofType)) {
			return false;
		}
		return true;
	 ...
	 *   different node type or is <code>null</code>
	 */
	public boolean match(ConstructorDeclaration node, Object other) {
	 ...
	 *   different node type or is <code>null</code>
	 */
	public boolean match(ForeachRangeStatement node, Object other) {
		if (!(other instanceof ForeachRangeStatement)) {
			return false;
		}
		ForeachRangeStatement o = (ForeachRangeStatement) other;
		return (
			node.isReverse() == o.isReverse()
			&& safeSubtreeMatch(node.getArgument(), o.getArgument())
			&& safeSubtreeMatch(node.getFromExpression(), o.getFromExpression())
	 ...
	 *   different node type or is <code>null</code>
	 */
	public boolean match(TraitsExpression node, Object other) {
		if (!(other instanceof TraitsExpression)) {
			return false;
		}
		TraitsExpression o = (TraitsExpression) other;
		return (
			safeSubtreeMatch(node.getName(), o.getName())
			&& safeSubtreeListMatch(node.arguments(), o.arguments())
			);
	 ...
	 *   different node type or is <code>null</code>
	 */
	public boolean match(CastToModifierExpression node, Object other) {
		if (!(other instanceof CastToModifierExpression)) {
			return false;
		}
	 ...
	 *   different node type or is <code>null</code>
	 */
	public boolean match(ModifiedType node, Object other) {
		if (!(other instanceof ModifiedType)) {
			return false;
		}
		ModifiedType o = (ModifiedType) other;
		return (
			safeSubtreeMatch(node.getModifier(), o.getModifier())
			&& safeSubtreeMatch(node.getComponentType(), o.getComponentType())
			);
	 ...
	 *   different node type or is <code>null</code>
	 */
	public boolean match(StructExpression node, Object other) {
		if (!(other instanceof StructExpression)) {
			return false;
		}
		StructExpression o = (StructExpression) other;
		return (
			safeSubtreeListMatch(node.expressions(), o.expressions())
			);
	}
