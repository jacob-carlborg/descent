...
public class VersionAssignment extends Declaration {
	...
	internalPreDDocsPropertyFactory(VersionAssignment.class); //$NON-NLS-1$

	/**
	 * The "modifiers" structural property of this node type.
	 */
	public static final ChildListPropertyDescriptor MODIFIERS_PROPERTY =
	internalModifiersPropertyFactory(VersionAssignment.class); //$NON-NLS-1$
	...
	internalPostDDocPropertyFactory(VersionAssignment.class); //$NON-NLS-1$
