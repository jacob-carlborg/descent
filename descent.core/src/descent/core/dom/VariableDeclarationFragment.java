...
public class VariableDeclarationFragment extends ASTNode {
	...
	public static final ChildPropertyDescriptor INITIALIZER_PROPERTY =
		new ChildPropertyDescriptor(VariableDeclarationFragment.class, "initializer", Initializer.class, OPTIONAL, NO_CYCLE_RISK); //$NON-NLS-1$
	...
	static {
		...
		createPropertyList(VariableDeclarationFragment.class, properyList);
	...
	/**
	 * Creates a new unparented variable declaration fragment node owned by the given 
	 * AST.
	 * <p>
	...
	/**
	 * Returns the name of this variable declaration fragment.
	 * 
	 * @return the name
	 */ 
	...
	/**
	 * Sets the name of this variable declaration fragment.
	 * 
	 * @param name the name
	...
	/**
	 * Returns the initializer of this variable declaration fragment.
	 * 
	...
	/**
	 * Sets the initializer of this variable declaration fragment.
	 * 
