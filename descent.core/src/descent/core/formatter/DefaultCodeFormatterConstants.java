...
public class DefaultCodeFormatterConstants {
	...
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ANON_CLASS = JavaCore.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_anon_class";
	public static final String FORMATTER_INSERT_SPACE_BEFORE_OPENING_PAREN_IN_ANON_FUNCTION = JavaCore.PLUGIN_ID + ".formatter.insert_space_before_opening_paren_in_anon_function";
