...
public interface IProblem {
	...
	int ModuleIsInMultiplePackages = 320;
	int ModuleIsInMultipleDefined = 321;
	int NeedUpperAndLowerBoundToSlicePointer = 322;
	int NeedUpperAndLowerBoundToSliceTuple = 323;
	int CannotConvertStringLiteralToVoidPointer = 324;
	int SymbolIsNotAPreInstanceInitializableField = 325;
	int NoCaseStatementFollowingGoto = 326;
	int SwitchStatementHasNoDefault = 327;
	int SymbolIsNotAFunctionTemplate = 328;
	int TupleIsNotAValidTemplateValueArgument = 329;
	int IncompatibleArgumentsForTemplateInstantiation = 330;
	int ThrowStatementsCannotBeInContracts = 331;
	int CanOnlyThrowClassObjects = 332;
	int StringExpectedAsSecondArgument = 333;
	int WrongNumberOfArguments = 334;
	int StringMustBeChars = 335;
	int InvalidFirstArgument = 336;
	int FirstArgumentIsNotAClass = 337;
	int ArgumentHasNoMembers = 338;
	int KindSymbolHasNoMembers = 339;
	int DotOffsetDeprecated = 340;
	int NoClassInfoForComInterfaceObjects = 341;
	int CannotMakeReferenceToABit = 342;
	int CannotFormTupleOfTuples = 343;
	int MissingInitializerInStaticConstructorForConstVariable = 344;
	int GlobalsStaticsFieldsRefAndAutoParametersCannotBeAuto = 345;
	int ReferenceToScopeClassMustBeScope = 346;
	int NumberOfKeysMustMatchNumberOfValues = 347;
	int ExpectedNumberArguments = 348;
	int ArraySliceIfOutOfBounds = 349;
	int InvalidUCS32Char = 350;
	int TupleIndexExceedsBounds = 351;
	int SliceIsOutOfRange = 352;
