...
public interface IProblem {
	...
	int TemplateIdentifierIsNotAMemberOfUndefined = 390;
	int CanOnlyInitiailizeConstMemberInsideConstructor = 391;
	int SymbolIsNotAMember = 392;
	int SymbolIsNotATemplate = 393;
	int DSymbolHasNoSize = 394;
	int ExpressionOfTypeDoesNotHaveABooleanValue = 395;
	int ImplicitConversionCanCauseLossOfData = 396;
	int ForwardReferenceToType = 397;
	int FloatingPointConstantExpressionExpected = 398;
	int ExpressionIsNotAValidTemplateValueArgument = 399;
	int InvalidRangeLowerBound = 400;
	int InvalidRangeUpperBound = 401;
	int SymbolIsNotAScalarType = 402;
	int ForeachIndexMustBeType = 403;
	int ForeachValueMustBeType = 404;
	int OpApplyFunctionMustReturnAnInt = 405;
	int FunctionOfTypeOverridesButIsNotCovariant = 406;
	int CannotOverrideFinalFunction = 407;
	int IncompatibleCovariantTypes = 408;
	int CannotUseTemplateToAddVirtualFunctionToClass = 409;
	int OutResultIsAlreadyDefined = 410;
	int MissingInitializerForConstField = 411;
	int MissingInitializerForFinalField = 412;
	int ImportNotFound = 413;
	int SymbolMustBeAnArrayOfPointerType = 414;
	int RvalueOfInExpressionMustBeAnAssociativeArray = 415;
	int InterfaceInheritsFromDuplicateInterface = 416;
	int LabelIsAlreadyDefined = 417;
	int CannotSubtractPointerFromSymbol = 418;
	int ThisForNestedClassMustBeAClassType = 419;
	int CanOnlyDereferenceAPointer = 420;
	int OuterClassThisNeededToNewNestedClass = 421;
	int ThisForNestedClassMustBeOfType = 422;
	int NoConstructorForSymbol = 423;
	int NoAllocatorForSymbol = 424;
	int NegativeArrayIndex = 425;
	int NewCanOnlyCreateStructsDynamicArraysAndClassObjects = 426;
	int MismatchedFunctionReturnTypeInference = 427;
	int ShiftLeftExceeds = 428;
	int SymbolCannotBeSlicedWithBrackets = 429;
	int SliceExpressionIsNotAModifiableLvalue = 430;
	int SymbolIsNotAMemberOf = 431;
	int MoreInitiailizersThanFields = 432;
	int OverlappingInitiailization = 433;
	int CannotMakeExpressionOutOfInitializer = 434;
	int NoDefaultOrCaseInSwitchStatement = 435;
	int SymbolIsNotASymbol = 436;
	int ForwardReferenceToTemplate = 437;
	int ForwardReferenceToTemplateDeclaration = 438;
	int SpecializationNotAllowedForDeducedParameter = 439;
	int CannotDeclareTemplateAtFunctionScope = 440;
	int TemplateHasNoValue = 441;
	int CannotUseLocalAsTemplateParameter = 442;
	int NoSizeForType = 443;
	int SymbolDotSymbolIsNotADeclaration = 444;
	int ThisIsRequiredButIsNotABaseClassOf = 445;
	int ForwardReferenceToSymbol = 446;
	int IdentifierOfSymbolIsNotDefined = 447;
	int StructIsForwardReferenced = 448;
	int CannotUseTemplateToAddFieldToAggregate = 449;
	int CannotModifyFinalVariable = 450;
	int InvalidUtf8Sequence2 = 451;
	int Utf16HighValuePastEndOfString = 452;
	int Utf16LowValueOutOfRange = 453;
	int UnpairedUtf16Value = 454;
	int IllegalUtf16Value = 455;
	int StaticConstructorCanOnlyBePartOfStructClassModule = 456;
	int ShiftAssignIsOutsideTheRange = 457;
	int TemplateTupleParameterMustBeLastOne = 458;
	int SymbolIsNestedInBoth = 459;
	int FunctionIsAbstract = 460;
	int KindSymbolDoesNotOverload = 461;
	int MismatchedTupleLengths = 462;
	int DoNotUseNullWhenComparingClassTypes = 463;
	int UseTokenInsteadOfTokenWhenComparingWithNull = 464;
	int VoidDoesNotHaveAnInitializer = 465;
	int FunctionNameExpectedForStartAddress = 466;
	int TypeofReturnMustBeInsideFunction = 467;
	int PostBlitsAreOnlyForStructUnionDefinitions = 468;
	int CannotHaveEDotTuple = 469;
	int CannotCreateCppClasses = 470;
	int SwitchAndCaseAreInDifferentFinallyBlocks = 471;
	int SwitchAndDefaultAreInDifferentFinallyBlocks = 472;
	int CannotHaveFieldWithSameStructType = 473;
	int WithoutThisCannotBeConstInvariant = 474;
	int CannotModifySymbol = 475;
	int CannotCallPublicExportFunctionFromInvariant = 476;
	int TemplateMemberFunctionNotAllowedInInterface = 477;
	int ArgumentToTypeofIsNotAnExpression = 478;
	int CannotInferTypeFromOverloadedFunctionSymbol = 479;
	int SymbolIsNotMutable = 480;
	int SymbolForSymbolNeedsToBeType = 481;
	int CannotModifyConstInvariant = 482;
	int SymbolCanOnlyBeCalledOnAnInvariantObject = 483;
	int SymbolCanOnlyBeCalledOnAMutableObject = 484;
	int CannotCallMutableMethodOnFinalStruct = 485;
	int ForwardReferenceOfImport = 486;
