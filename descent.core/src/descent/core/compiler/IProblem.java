...
public interface IProblem {
	...
	int KindSymbolHasNoMembers = 342;
	int DotOffsetDeprecated = 343;
	int NoClassInfoForComInterfaceObjects = 344;
	int CannotMakeReferenceToABit = 345;
	int CannotFormTupleOfTuples = 346;
	int MissingInitializerInStaticConstructorForConstVariable = 347;
	int GlobalsStaticsFieldsRefAndAutoParametersCannotBeAuto = 348;
	int ReferenceToScopeClassMustBeScope = 349;
	int NumberOfKeysMustMatchNumberOfValues = 350;
	int ExpectedNumberArguments = 351;
	int ArraySliceIfOutOfBounds = 352;
	int InvalidUCS32Char = 353;
	int TupleIndexExceedsBounds = 354;
	int SliceIsOutOfRange = 355;
	int CannotTakeAddressOf = 356;
	int VariableIsUsedBeforeInitialization = 357;
	int EscapingReferenceToLocal = 358;
	int CanOnlyCatchClassObjects = 359;
	int BaseClassIsForwardReferenced = 360;
	int BaseIsForwardReferenced = 361;
	int CannotInheritFromFinalClass = 362;
	int StaticClassCannotInheritFromNestedClass = 363;
	int SuperClassIsNestedWithin = 364;
	int ArrayComparisonTypeMismatch = 365;
	int ConditionalExpressionIsNotAModifiableLvalue = 366;
	int CannotCastSymbolToSymbol = 367;
	int CannotDeleteInstanceOfComInterface = 368;
	int TemplateIsNotAMemberOf = 369;
	int TemplateIdentifierIsNotAMemberOf = 370;
	int CanOnlyInitiailizeConstMemberInsideConstructor = 371;
	int SymbolIsNotAMember = 372;
	int SymbolIsNotATemplate = 373;
	int DSymbolHasNoSize = 374;
	int ExpressionOfTypeDoesNotHaveABooleanValue = 375;
	int ImplicitConversionCanCauseLossOfData = 376;
	int ForwardReferenceToType = 377;
	int FloatingPointConstantExpressionExpected = 378;
	int ExpressionIsNotAValidTemplateValueArgument = 379;
	int InvalidRangeLowerBound = 380;
	int InvalidRangeUpperBound = 381;
	int SymbolIsNotAScalarType = 382;
	int ForeachIndexMustBeType = 383;
	int ForeachValueMustBeType = 384;
	int OpApplyFunctionMustReturnAnInt = 385;
	int FunctionOfTypeOverridesButIsNotCovariant = 386;
	int CannotOverrideFinalFunction = 387;
	int IncompatibleCovariantTypes = 388;
	int CannotUseTemplateToAddVirtualFunctionToClass = 389;
	int OutResultIsAlreadyDefined = 390;
	int MissingInitializerForConstField = 391;
	int SomethingNotFound = 392;
	int SymbolMustBeAnArrayOfPointerType = 393;
	int RvalueOfInExpressionMustBeAnAssociativeArray = 394;
	int InterfaceInheritsFromDuplicateInterface = 395;
	int LabelIsAlreadyDefined = 396;
	int CannotSubtractPointerFromSymbol = 397;
	int ThisForNestedClassMustBeAClassType = 398;
	int CanOnlyDereferenceAPointer = 399;
	int OuterClassThisNeededToNewNestedClass = 400;
	int ThisForNestedClassMustBeOfType = 401;
	int NoConstructorForSymbol = 402;
	int NoAllocatorForSymbol = 403;
