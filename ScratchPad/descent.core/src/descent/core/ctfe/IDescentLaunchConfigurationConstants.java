...
public interface IDescentLaunchConfigurationConstants {
	 ...
	 */
	public static final String ID_D_APPLICATION = PREFIX + ".application"; //$NON-NLS-1$
	
	/**
	 * Unique identifier for the ddbg debug model (value 
	 * <code>descent.debug.core.model</code>).
	 */
	public static final String ID_D_DEBUG_MODEL = PREFIX + ".model"; //$NON-NLS-1$
	 ...
	 * process.
	 */
	public static final String ATTR_WORKING_DIRECTORY = PREFIX + ".WORKING_DIRECTORY";	 //$NON-NLS-1$
	 ...
	 * on the command line.
	 */
	public static final String ATTR_PROGRAM_ARGUMENTS = PREFIX + ".PROGRAM_ARGUMENTS"; //$NON-NLS-1$
