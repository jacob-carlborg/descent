		...
		switch (element.getElementType()) {
			...
			case IJavaElement.TYPE :
				if (isRenamingMainType(element, dest)) {
					...
					String lineSeparator = descent.internal.core.util.Util.getLineSeparator(source, element.getJavaProject());
			...
			case IJavaElement.FIELD :
				...
				lineSeparator = descent.internal.core.util.Util.getLineSeparator(source, element.getJavaProject());
...
protected boolean isRenamingMainType(IJavaElement element, IJavaElement dest) throws JavaModelException {
	if ((isRename() || getNewNameFor(element) != null)
		...
		typeName = descent.internal.core.util.Util.getNameWithoutJavaLikeExtension(typeName);
