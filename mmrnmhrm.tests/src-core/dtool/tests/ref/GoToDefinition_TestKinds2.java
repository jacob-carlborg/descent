...
public class GoToDefinition_TestKinds2 extends FindDef_CommonTest  {
	...
	public GoToDefinition_TestKinds2(int offset, int targetOffset) throws IOException, CoreException {
