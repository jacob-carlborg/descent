...
public final class AST {
	 ...
	 * @since 3.1
	 */
	public List newModifiers(long flags) {
		...
		if (Modifier.isPackage(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.PACKAGE_KEYWORD));
		}
		...
		if (Modifier.isExport(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.EXPORT_KEYWORD));
		}
		...
		if (Modifier.isOverride(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.OVERRIDE_KEYWORD));
		}
		if (Modifier.isAuto(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.AUTO_KEYWORD));
		}
		if (Modifier.isSynchronized(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.SYNCHRONIZED_KEYWORD));
		}
		if (Modifier.isDeprecated(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.DEPRECATED_KEYWORD));
		}
		if (Modifier.isExtern(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.EXTERN_KEYWORD));
		}
		if (Modifier.isConst(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.CONST_KEYWORD));
		}
		if (Modifier.isScope(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.SCOPE_KEYWORD));
		}
		if (Modifier.isInvariant(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.INVARIANT_KEYWORD));
		}
		if (Modifier.isIn(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.IN_KEYWORD));
		}
		if (Modifier.isOut(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.OUT_KEYWORD));
		}
		if (Modifier.isInOut(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.INOUT_KEYWORD));
		}
		if (Modifier.isLazy(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.LAZY_KEYWORD));
		}
		if (Modifier.isRef(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.REF_KEYWORD));
		}
		if (Modifier.isEnum(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.ENUM_KEYWORD));
		}
		if (Modifier.isPure(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.PURE_KEYWORD));
		}
		if (Modifier.isNothrow(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.NOTHROW_KEYWORD));
		}
		if (Modifier.isThread(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.THREAD_KEYWORD));
		}
		if (Modifier.isShared(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.SHARED_KEYWORD));
		}
		if (Modifier.isGshared(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.GSHARED_KEYWORD));
		}
		if (Modifier.isImmutable(flags)) {
			result.add(newModifier(Modifier.ModifierKeyword.IMMUTABLE_KEYWORD));
		}
		return result;
	}
