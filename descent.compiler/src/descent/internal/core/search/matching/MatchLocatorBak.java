...
//	 permanent state
	...
	public MatchLocatorBak(SearchPattern pattern, SearchRequestor requestor, IJavaSearchScope scope, SubProgressMonitor progressMonitor) {
