...
private static final Comparator PROBLEM_COMPARATOR = new Comparator() {
	public int compare(Object o1, Object o2) {
		return ((IProblem) o1).getSourceStart() - ((IProblem) o2).getSourceStart();
	}
};
...
public IProblem[] getProblems() {
	...
	if (this.problems != null) {
		...
		if (this.problemCount != this.problems.length) {
			System.arraycopy(this.problems, 0, (this.problems = new IProblem[this.problemCount]), 0, this.problemCount);
		}
...
private void quickPrioritize(IProblem[] problemList, int left, int right) {
...
public void record(IProblem newProblem, ReferenceContext referenceContext) {
	...
	if (this.problemCount == 0) {
		...
		System.arraycopy(this.problems, 0, (this.problems = new IProblem[this.problemCount * 2]), 0, this.problemCount);
	}
	...
	if ((newProblem.getID() & IProblem.CAT_SYNTAX) != 0 && newProblem.isError())
