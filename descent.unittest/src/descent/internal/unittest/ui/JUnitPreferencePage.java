...
import descent.ui.IJavaElementSearchConstants;
...
//import descent.internal.unittest.launcher.AssertionVMArg;
import descent.internal.unittest.util.ExceptionHandler;
...
public class JUnitPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	private void createEnableAssertionsCheckbox(Composite container) {
		...
		setAssertionCheckBoxSelection(false/* TODO AssertionVMArg.getEnableAssertionsPreference() */);
	}
	...
	public boolean performOk() {
		/* TODO AssertionVMArg.setEnableAssertionsPreference(getAssertionCheckBoxSelection()); */
