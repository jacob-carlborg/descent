...
public class EnableStackFilterAction extends Action {
	...
	public EnableStackFilterAction(FailureTrace view) {
		...
		setDisabledImageDescriptor(DescentUnittestPlugin.getImageDescriptor("dlcl16/cfilter.gif")); //$NON-NLS-1$
		setHoverImageDescriptor(DescentUnittestPlugin.getImageDescriptor("elcl16/cfilter.gif")); //$NON-NLS-1$
		setImageDescriptor(DescentUnittestPlugin.getImageDescriptor("elcl16/cfilter.gif")); //$NON-NLS-1$
