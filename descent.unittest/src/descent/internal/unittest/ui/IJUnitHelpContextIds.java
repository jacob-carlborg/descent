...
public interface IJUnitHelpContextIds {
	public static final String PREFIX= DescentUnittestPlugin.PLUGIN_ID + '.';
	...
	public static final String JUNIT_PREFERENCE_PAGE= PREFIX + "unittest_preference_page_context"; //$NON-NLS-1$
