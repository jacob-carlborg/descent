...
public final class JUnitMessages extends NLS {
	...
	public static String JUnitAddLibraryProposa_unittest4_label;
	...
	public static String JUnitAddLibraryProposal_unittest4_info;
	...
	public static String JUnitBaseLaunchConfiguration_error_unittestnotonpath;
	public static String JUnitBaseLaunchConfiguration_error_unittest4notonpath;
	...
	public static String JUnitContainerInitializer_description_initializer_unittest3;

	public static String JUnitContainerInitializer_description_initializer_unittest4;

	public static String JUnitContainerInitializer_description_initializer_unresolved;

	public static String JUnitContainerInitializer_description_unittest3;

	public static String JUnitContainerInitializer_description_unittest4;
	...
	public static String JUnitContainerWizardPage_option_unittest3;

	public static String JUnitContainerWizardPage_option_unittest4;
