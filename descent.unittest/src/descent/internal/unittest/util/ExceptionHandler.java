...
//import descent.internal.unittest.wizards.WizardMessages;
 ...
 * 
 * TO DO: this class is duplicated from descent.ui
 */
public class ExceptionHandler {
	...
	private void displayMessageDialog(Throwable t, String exceptionMessage, Shell shell, String title, String message) {
		...
		if (exceptionMessage == null || exceptionMessage.length() == 0)
			msg.write("n00b go see err log"/* TODO WizardMessages.ExceptionDialog_seeErrorLogMessage */); 
		else
