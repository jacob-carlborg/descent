...
//import descent.internal.unittest.wizards.MethodStubsSelectionButtonGroup;
...
public class LayoutUtil {
	 ...
	 */
	/* TODO public static int getNumberOfColumns(MethodStubsSelectionButtonGroup[] editors) {
		int columnCount= 0;
	 ...
	 */	
	/* TODO public static void doDefaultLayout(Composite parent, MethodStubsSelectionButtonGroup[] editors, boolean labelOnTop) {
	 ...
	 */
	/* TODO public static void doDefaultLayout(Composite parent, MethodStubsSelectionButtonGroup[] editors, boolean labelOnTop, int minWidth, int minHeight) {
		doDefaultLayout(parent, editors, labelOnTop, minWidth, minHeight, 0, 0);
	} */
	
	/* TODO public static void doDefaultLayout(Composite parent, MethodStubsSelectionButtonGroup[] editors, boolean labelOnTop, int minWidth, int minHeight, int marginWidth, int marginHeight) {
