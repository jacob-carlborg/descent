...
import descent.internal.debug.ui.actions.ControlAccessibleListener;
...
public class ArgumentsTab extends AbstractLaunchConfigurationTab {
	...
	public Image getImage() {
		return DescentDebugUI.getDefault().getImageRegistry().get(Images.VARIABLE_TAB);
	}
