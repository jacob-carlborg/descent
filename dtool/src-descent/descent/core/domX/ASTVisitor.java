...
public abstract class ASTVisitor extends TreeVisitor<ASTNode> {
	...
	/* -----------   ---------- */
	public boolean visit(Argument element) {
		return visitAsSuperType(element, Argument.class);
	}
	
	public boolean visit(BaseClass element) {
		return visitAsSuperType(element, BaseClass.class);
	}
	
	public boolean visit(Catch element) {
		return visitAsSuperType(element, Catch.class);
	}
	...
	public boolean visit(ITrueExpression element) {
		return visit((IntegerExp)element);
	}
	public boolean visit(IFalseExpression element) {
		return visit((IntegerExp)element);
	}
	public boolean visit(IIntegerExpression element) {
		return visit((IntegerExp)element);
	}	
