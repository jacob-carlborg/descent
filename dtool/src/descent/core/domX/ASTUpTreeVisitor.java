...
*/
	...
	public boolean visit(ModifierDeclaration node) {
		Assert.isTrue(ModifierDeclaration.class.getSuperclass().equals(Dsymbol.class));
		return visit((Dsymbol) node);
	}
	...
	public boolean visit(ParenExp node) {
		Assert.isTrue(ParenExp.class.getSuperclass().equals(UnaExp.class));
		return visit((UnaExp) node);
	}
	...
	public boolean visit(TypeInfoStructureDeclaration node) {
		Assert.isTrue(TypeInfoStructureDeclaration.class.getSuperclass().equals(TypeInfoDeclaration.class));
		return visit((TypeInfoDeclaration) node);
	}
	...
	public boolean visit(TypeTupleDelegateDeclaration node) {
		Assert.isTrue(TypeTupleDelegateDeclaration.class.getSuperclass().equals(TypeInfoDeclaration.class));
		return visit((TypeInfoDeclaration) node);
	}
